...
<head>
    ...
    <script type="text/javascript">
        ...
        function insertCategory(){
            ...
            subEn = $("#subEn").val();
            subHi = $("#txtHindi2").val();
            if(catEn.length == 0 && catHi.length == 0 && subEn.length == 0 && subHi.length == 0){
            ...
            $.ajax({
                type: "POST",
                url: "item_query.php",
                data: { "task" : "categoryInsert","catEn":catEn,"catHi":catHi,"subEn":subEn,"subHi":subHi},
    ...
    <script language=javascript type="text/javascript">
        ...
        function showKeyboard(field,div,focusState){
            //var curElement = document.activeElement.getAttribute('id');
            changeField(field);
            console.log(field,div,focusState);
...
//                    divElem.style.height="auto";
                    ...
                    console.log("from Function:"+curElement);
        ...
        function setCurElem(field){

            curElement = field;
            console.log("setCurElem:"+curElement);
        }
    </script>
...
/*            //width: 100%;*/
        ...
        td:nth-child(1), th:nth-child(1) { width: 30px  ; border-right: 1px solid brown;}
        td:nth-child(2), th:nth-child(2) { width: 135px; }
        td:nth-child(3), th:nth-child(3) { width: 135px; border-right: 1px solid brown;}
...
<body>
    <div id="mainKeyboard" style="visibility: hidden;">
        ...
        <div id="top" style="z-index:0;position:absolute; top:0px; left:0px; visibility: inherit;">
        ...
        <div id="normal" style="z-index:1;position:absolute; top:0px; left:0px; visibility: inherit;" onmouseover="setCurElem('normal');" onmouseout="setCurElem('');">
        ...
        <div id="shift" style="z-index:1;position:absolute; top:0px; left:0px; visibility:hidden" onmouseover="setCurElem('shift');" onmouseout="setCurElem('');">
        ...
        <div id="caps" style="z-index:1;position:absolute; top:0px; left:0px; visibility:hidden" onmouseover="setCurElem('caps');" onmouseout="setCurElem('');">
    ...
    <div id="main">
        ...
        <div id="rightHolder">
            ...
            <form id="addCat">
                ...
                Category Name[Eng]:<input type="text" id="catEn"/><br/><br/>
                Category Name[Hin]:<input type="text" id="txtHindi1" name="txtHindi1" onfocus="showKeyboard('txtHindi1','textHi1','in');" onblur="showKeyboard('txtHindi1','textHi1','out');"/><br/>
                <div id="textHi1" style="visibility: hidden; border-collapse: collapse;"></div><br/>
                Sub-Category[Hin]:<input type="text" id="subEn"/><br/><br/>
                Sub-Category[Eng]: <input type="text" id="txtHindi2" name="txtHindi2" onfocus="showKeyboard('txtHindi2','textHi2','in');" onblur="showKeyboard('txtHindi2','textHi2','out');"/>
                <div id="textHi2" style="visibility: hidden; border-collapse: collapse; "></div>
                <br/><br/>
                <button type="button" onclick="insertCategory()">SUBMIT</button>
            </form>
    ...
    <script>
        ...
        {
            document.getElementById('txtHindi1').onkeydown=checkCode;
            document.getElementById('txtHindi1').onkeypress=writeKeyPressed;
            document.getElementById('txtHindi1').onkeyup=restoreCode;
